...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a href="user data.php">Registration</a></li>
			<li><a href="read tag.php">Read Tag ID</a></li>
			<li><a class="active" href="tst.php">tst</a></li>
		</ul>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<br>
				<form class="form-horizontal" action="output read tag page.php" method="post" >
					...
					<div class="form-actions">
						<button type="submit" class="btn btn-success">OUTPUT</button>
                    </div>
					</div>
