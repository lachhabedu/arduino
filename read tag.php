...
<html>
	<head>
		...
		<title>Read Tag : Rfid and Nfc time attendance system Ardino uno web server</title>
	</head>
	
	<body>
		<h2 align="center">Rfid and Nfc time attendance system Ardino uno web server</h2>
		<ul class="topnav">
				...
				<table  width="452" border="1" bordercolor="#10a0c5" align="center"  cellpadding="0" cellspacing="1"  bgcolor="#000" style="padding: 2px">
					...
					<tr>
						<td  bgcolor="#f9f9f9">
							...
							echo '<td><a class="btn btn-success" href="input read tag page.php?">input</a>';
							echo ' ';
							echo '<a class="btn btn-danger" href="output read tag page.php?">output</a>';
